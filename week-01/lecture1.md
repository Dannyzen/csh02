...
- For now: a physical implementation of a logical instructions.
- A computer can have many implementations from the physical world<sup>1</sup>.
...
Don't be insulted if you already know this, it's important to develop some intuition. :)
